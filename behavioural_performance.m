...
tbl_DV1_mean = table(meanperf,Afbtype,thr,missed_resp_perset, subj_sel);
DV1_mean = [meanperf Afbtype thr missed_resp_perset subj_sel];
...
tbl_DV1_mean_fmri = table(avg_fmri,Afbtype,thr,missed_resp_perset);
